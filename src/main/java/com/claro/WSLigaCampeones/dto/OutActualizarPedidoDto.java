...
public class OutActualizarPedidoDto {
	...
	private String respuestaActualizacion;
	...
	public void setRespuestaActualizacion(String respuestaActualizacion) {
		this.respuestaActualizacion = respuestaActualizacion;
	}
	@Override
	public String toString() {
		return "OutActualizarPedidoDto [cedulaUsuario=" + cedulaUsuario + ", celular=" + celular + ", nombre=" + nombre
				+ ", apellido=" + apellido + ", correo=" + correo + ", nombreCategoria=" + nombreCategoria
				+ ", nombreProducto=" + nombreProducto + ", cantidad=" + cantidad + ", Costo=" + Costo + ", puntos="
				+ puntos + ", departamento=" + departamento + ", ciudad=" + ciudad + ", direccion=" + direccion
				...
				+ ", respuestaActualizacion=" + respuestaActualizacion + "]";
	}
